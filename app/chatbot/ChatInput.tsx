...
const ChatInput = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    SendingMessage({message: properPrompt, addMessage: addMessage, deleteMessage: deleteMessage})
  ...
  return (
    <div className='w-full flex justify-center pb-6 bg-700/50'>
      ...
      <form className=' border border-white border-opacity-30 flex flex-row items-center w-full lg:w-2/4 p-2 rounded-2xl h-14'
        onSubmit={(e) => {
          handleSubmit(e)
      ...
      >
        ...
        <input className='w-full h-full max-w-3xl  bg-inherit text-white  p-4 outline-none rounded-lg text-sm'
          type="text"
