...
const Message = ({ content, role }: any) => {
	return (
		<div
			className={`flex flex-col space-x-2 space-y-2 w-full px-10 max-w-3xl  mx-auto `}>
			<div className='flex flex-row'>
				{role === 'assistant' ? (
					<BotIcon className='w-7 h-7 mr-2 bg-green-300 rounded-full p-1.5' />
				) : (
			...
			<ReactMarkDown className='text-white text-opacity-90 items-baseline markdown-content'>
				{content}
			</ReactMarkDown>
